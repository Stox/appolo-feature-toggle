...
module.exports = Class.define({
    ...
    isActive: function (key) {
        ...
        if(feature){
            ...
            if(isActive && this._options.environmentName){
                isActive = _.contains(feature.environments,this._options.environmentName);
            }
        }
    ...
    setFeatures:function(data){
        ...
        this._activeFeatures = _.filter(data, function(feature){
            return this.isActive(feature.name)
        },this);
